...
//  { "#72c6fa", "#c5c8c6", "#1d1f21" }, // 2 = selected (white on black)
  { "#ff6a97", "#c5c8c6", "#1d1f21" }, // 2 = new selected
...
static const char *dmenuorg[]      = { "dmenu_run", "-fn", font, "-nb", colors[0][ColBG], "-nf", colors[0][ColFG], "-sb", colors[1][ColBG], "-sf", colors[1][ColFG], NULL };
...
static Key keys[] = {
  ...
  { MODKEY,                 XK_o,             spawn,          {.v = dmenuorg} },
  { 0,                      0x1008ff13,       spawn,          {.v = volupcmd } },
  { 0,                      0x1008ff11,       spawn,          {.v = voldncmd } },
  { 0,                      0x1008ff14,       spawn,          {.v = mpctog } },
  { 0,                      0x1008ff16,       spawn,          {.v = mpcprev } },
  { 0,                      0x1008ff17,       spawn,          {.v = mpcnext } },
  { 0,                      0x1008ff8B,       spawn,          {.v = termcmd } },
  { 0,                      0x1008ff8E,       spawn,          {.v = gvim } },
  { 0,                      0x1008ff8A,       spawn,          {.v = htop } },
  { 0,                      0x1008ff8C,       spawn,          {.v = trans} },
